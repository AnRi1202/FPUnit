...
set f500_dir "../src/rtl/base_f500"
    analyze -library WORK -format vhdl "$f500_dir/fpadd_f500.vhdl"
    analyze -library WORK -format vhdl "$f500_dir/fpmult_f500.vhdl"
    analyze -library WORK -format vhdl "$f500_dir/fpdiv_f500.vhdl"
    analyze -library WORK -format vhdl "$f500_dir/fpsqrt_f500.vhdl"
    analyze -library WORK -format vhdl "$f500_dir/fpadd_bf16_f500.vhdl"
    analyze -library WORK -format vhdl "$f500_dir/fpmult_bf16_f500.vhdl"
    analyze -library WORK -format vhdl "$f500_dir/f500_fpall_origin.vhdl"
elaborate f500_fpall_origin -architecture arch -library WORK -parameters "NUM_OPS=${NUM_OPS}"
...
# elaborate f500_fpall_origin -architecture arch -library WORK
