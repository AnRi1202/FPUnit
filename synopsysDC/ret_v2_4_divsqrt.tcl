# ======================================================================
# DC script (retiming for divsqrt_only_ret.sv - V2.4)
# ======================================================================
...
set run_dir [file normalize "run-v2_4_divsqrt-P${num_pipe}-T${main_clock_period}-${tag}"]
...
analyze -library WORK -format sverilog "$v2_4_dir/fpall_pkg.sv"
