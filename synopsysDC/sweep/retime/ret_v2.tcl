# ======================================================================
# DC script (retiming for fpall_shared_ret.sv)
...
set run_dir [file normalize "$sweep_root/run-v2_ret-AM${num_pipe_am}-DS${num_pipe_ds}-T${main_clock_period}-${tag}"]
...
elaborate fpall_shared_ret -library WORK -parameters "PARAM_PIPE_AM=${num_pipe_am}, PARAM_PIPE_DS=${num_pipe_ds}"
