# ======================================================================
# DC script (retiming for FPDivSqrt_origin_ret.vhdl - Div+Sqrt only)
# This script synthesizes the FloPoCo Div+Sqrt baseline with retiming.
# ======================================================================
...
set run_dir [file normalize "$sweep_root/run-flopoco_origin_divsqrt_ret-P${num_pipe}-T${main_clock_period}-${tag}"]
...
# Elaborate Div+Sqrt retiming wrapper with NUM_PIPE parameter
elaborate FPDivSqrt_origin_ret -library WORK -parameters "NUM_PIPE=${num_pipe}"
