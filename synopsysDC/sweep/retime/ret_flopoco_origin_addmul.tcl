# ======================================================================
# DC script (retiming for FPAddMul_origin_ret.vhdl - Add+Mul only)
# This script synthesizes the FloPoCo Add+Mul baseline with retiming.
# ======================================================================
...
set run_dir [file normalize "$sweep_root/run-flopoco_origin_addmul_ret-P${num_pipe}-T${main_clock_period}-${tag}"]
...
# Elaborate Add+Mul retiming wrapper with NUM_PIPE parameter
elaborate FPAddMul_origin_ret -library WORK -parameters "NUM_PIPE=${num_pipe}"
