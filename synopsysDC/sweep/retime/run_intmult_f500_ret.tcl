# ======================================================================
# DC script: Pass 1 - Retiming for IntMultiplier_24x24_48_Freq500_uid5
# ======================================================================
set_host_options -max_cores 8
remove_design -all

set main_clock_period 1.25

set sweep_root "sweep_run/retime"
file mkdir $sweep_root
set run_dir "$sweep_root/run-intmult_f500_ret"
...
# Analyze & Elaborate
analyze -library WORK -format vhdl "../src/rtl/base_f500/intmult_f500_ret.vhdl"
elaborate IntMultiplier_24x24_48_Freq500_uid5
...
# Output
write_file -format verilog -hierarchy -output "intmult_f500_ret.v"
