# ======================================================================
# DC script: FPMult (retimed IntMult) + BF16 Mul x2  --  Freq300
# ======================================================================
...
set run_dir  "$sweep_root/run-fpmult_with_bf16_f300"
...
analyze -library WORK -format vhdl "../src/rtl/base_f300/fpmult_bf16_f300.vhdl"
analyze -library WORK -format vhdl "../src/rtl/base_f300/f300_fpmult_with_bf16.vhdl"

# Read retimed IntMult netlist
read_file -format verilog "./intmult_f300_ret.v"

elaborate f300_fpmult_with_bf16
link
check_design
set_max_area 0
