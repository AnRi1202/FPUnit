# ======================================================================
# DC script: Pass 1 - Retiming for IntMultiplier_24x24_48_Freq400_uid5
# ======================================================================
set_host_options -max_cores 8
remove_design -all

set main_clock_period 1.5

set sweep_root "sweep_run/retime"
file mkdir $sweep_root
set run_dir "$sweep_root/run-intmult_f400_ret"
...
# Analyze & Elaborate
analyze -library WORK -format vhdl "../src/rtl/base_f400/intmult_f400_ret.vhdl"
elaborate IntMultiplier_24x24_48_Freq400_uid5
...
# Output
write_file -format verilog -hierarchy -output "intmult_f400_ret.v"
