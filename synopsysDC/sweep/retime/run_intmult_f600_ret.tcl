# ======================================================================
# DC script: Pass 1 - Retiming for IntMultiplier_24x24_48_Freq600_uid5
# ======================================================================
...
set run_dir "$sweep_root/run-intmult_f600_ret"
...
# Analyze & Elaborate
analyze -library WORK -format vhdl "../src/rtl/base_f600/intmult_f600_ret.vhdl"
elaborate IntMultiplier_24x24_48_Freq600_uid5
...
# Output
write_file -format verilog -hierarchy -output "intmult_f600_ret.v"
