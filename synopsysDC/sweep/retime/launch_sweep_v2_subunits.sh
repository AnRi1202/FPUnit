...
tmux send-keys -t $SESSION:1 "python3 sweep/retime/run_sweep_v2_3_addmul.py" C-m

# Create window for V2.4 Div/Sqrt sweep
tmux new-window -t $SESSION:2 -n "v2_4_divsqrt"
tmux send-keys -t $SESSION:2 "python3 sweep/retime/run_sweep_v2_4_divsqrt.py" C-m
