# ======================================================================
# DC script (retiming for FPMult_origin_ret.vhdl - FP32 Mult only)
# This script synthesizes the FloPoCo FPMult baseline with retiming.
# ======================================================================
...
set run_dir [file normalize "$sweep_root/run-flopoco_origin_fpmult_ret-P${num_pipe}-T${main_clock_period}-${tag}"]
...
# FPMult_origin_ret: FP32 Mult + BF16 Mult x2 (needs FPMult_Kin_f1, fpmult_bf16_f1)
analyze -library WORK -format vhdl "$rtl_dir/FPMult_Kin_f1_origin.vhdl"
analyze -library WORK -format vhdl "$rtl_dir/fpmult_bf16_f1.vhdl"
analyze -library WORK -format vhdl "$rtl_dir/FPMult_origin_ret.vhdl"

elaborate FPMult_origin_ret -library WORK -parameters "NUM_PIPE=${num_pipe}"
