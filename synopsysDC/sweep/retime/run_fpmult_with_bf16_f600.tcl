# ======================================================================
# DC script: FPMult (retimed IntMult) + BF16 Mul x2  --  Freq600
# ======================================================================
...
set run_dir  "$sweep_root/run-fpmult_with_bf16_f600"
...
analyze -library WORK -format vhdl "../src/rtl/base_f600/fpmult_f600_nomult.vhdl"
analyze -library WORK -format vhdl "../src/rtl/base_f600/fpmult_bf16_f600.vhdl"
analyze -library WORK -format vhdl "../src/rtl/base_f600/f600_fpmult_with_bf16.vhdl"

# Read retimed IntMult netlist
read_file -format verilog "./intmult_f600_ret.v"

elaborate f600_fpmult_with_bf16
link
check_design
set_max_area 0
