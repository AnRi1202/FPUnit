# ======================================================================
# DC script: FPMult (retimed IntMult) + BF16 Mul x2  --  Freq500
# ======================================================================
...
set run_dir  "$sweep_root/run-fpmult_with_bf16_f500"
...
analyze -library WORK -format vhdl "../src/rtl/base_f500/fpmult_f500_nomult.vhdl"
analyze -library WORK -format vhdl "../src/rtl/base_f500/fpmult_bf16_f500.vhdl"
analyze -library WORK -format vhdl "../src/rtl/base_f500/f500_fpmult_with_bf16.vhdl"

# Read retimed IntMult netlist
read_file -format verilog "./intmult_f500_ret.v"

elaborate f500_fpmult_with_bf16
link
check_design
set_max_area 0
