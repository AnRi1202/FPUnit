# ======================================================================
# DC script (retiming for FPAdd_origin_ret.vhdl - FP32 Add only)
# This script synthesizes the FloPoCo FPAdd baseline with retiming.
# ======================================================================
...
set run_dir [file normalize "$sweep_root/run-flopoco_origin_fpadd_ret-P${num_pipe}-T${main_clock_period}-${tag}"]
...
# FPAdd_origin_ret: FP32 Add + BF16 Add x2 (needs FPAdd_Kin_f1, fpadd_bf16_f1)
analyze -library WORK -format vhdl "$rtl_dir/FPAdd_Kin_f1_origin.vhdl"
analyze -library WORK -format vhdl "$rtl_dir/fpadd_bf16_f1.vhdl"
analyze -library WORK -format vhdl "$rtl_dir/FPAdd_origin_ret.vhdl"

elaborate FPAdd_origin_ret -library WORK -parameters "NUM_PIPE=${num_pipe}"
