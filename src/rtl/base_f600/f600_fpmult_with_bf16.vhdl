-- ===========================================================================
-- FPMult (retimed IntMult) + BF16 Mul x2 wrapper  (Freq600 MHz)
...
entity f600_fpmult_with_bf16 is
    port (
        clk    : in  std_logic;
...
architecture arch of f600_fpmult_with_bf16 is
...
begin
    ...
    U_FP32MUL: FPMult_8_23_uid2_Freq600_uid3
    ...
    U_BFMUL_H: FPMult_8_7_uid2_Freq600_uid3
        port map (clk => clk, X => X(33 downto 16), Y => Y(33 downto 16), R => bfmul_h_R);
    U_BFMUL_L: FPMult_8_7_uid2_Freq600_uid3
