...
デフォルト: `SIM=xcelium`, `TARGET=v2_bf16_full`, `TEST_UNIT=fp32_add`
...
| `TARGET` | `v2_bf16_full` | ビルド対象RTL。Makefileと同一の選択肢が使える |
...
| `TARGET` | define |
|---|---|
| `v0_area_opt` | `V0_AREA_OPT` |
| `v1_area_opt` | `V1_AREA_OPT` |
| `v1_1_fp32_add` | `V1_1_FP32_ADD` |
| `v1_2_fp32_mult` | `V1_2_FP32_MULT` |
| `v1_3_addmul_only` | `V1_3_ADDMUL_ONLY` |
| `v2_bf16_full` | `V2_BF16_FULL` |
...
| `fp16_add` | `fp16_add_test.py` | `fp16_add_wrapper` |
| `fp16_mult` | `fp16_mult_test.py` | `fp16_mult_wrapper` |
