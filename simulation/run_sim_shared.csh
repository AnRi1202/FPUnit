...
set RUN_DIR  = "$RUN_BASE/run_shared-$TS"
...
# Parameters
set FILELIST = "$ROOT/simulation/filelist/compile_shared.f"
set TOP_MOD  = "tb_fpaddmul_shared"
...
# Update latest link
ln -sfn "$RUN_DIR" "$RUN_BASE/latest_shared"
