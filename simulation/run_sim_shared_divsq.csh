...
set RUN_DIR  = "$RUN_BASE/run_shared_divsq-$TS"
...
# Parameters
set FILELIST = "$ROOT/rtl/filelists/compile_fpall_shared_divsq.f"
set TOP_MOD  = "tb_fpall_shared_divsq"
...
# Update latest link
ln -sfn "$RUN_DIR" "$RUN_BASE/latest_shared_divsq"
